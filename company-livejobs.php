                        ...
                        <div class="container">
                            <div class="container-sm-height">
                                <div class="row-sm-height">
                                    <a class="col-xs-12 col-sm-3 col-sm-height btn btn-transparent active" ui-sref="business-jobs.live" ui-sref-active="active" href="company-livejobs.php?bid=<?php echo $bid; ?>">
                                        Live Jobs
                                        <?php
                        ...
                        <div class="container">
                            <div ui-view="">
                                <ul class="list-style-none">
                                    ...
                                    <?php
                                        $sqljobcheck = "SELECT * FROM jobs WHERE bid=\"$bid\" AND isactive=1;";    
