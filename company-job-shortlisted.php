<?php
    ...
    if(($_SESSION['email'])&&($_SESSION['password']))
    {
        ...
        if($action=='remove')
        {                
            $sql="UPDATE applicants SET status=\"Applied\" WHERE jid=\"$jid\" AND uid=\"$uid\";";
            $res=mysql_query($sql);
        }
                            ...
                            <div class="container">
                                <div class="container-sm-height">
                                    <div class="row-sm-height">
                                        ...
                                        <div class="col-xs-12 col-sm-height btn btn-transparent col-sm-2 active" href="company-job-shortlisted.php?jid=<?php echo $jid; ?>" onclick="location.href='company-job-shortlisted.php?jid=<?php echo $jid; ?>'">
                                            Shortlisted
                                            <?php
                                ...
                                <div class="col-xs-12">
                                    <div ui-view="">
                                        <div>
                                            <div class="pull-right found-count">
                                                <div ng-switch="vj.tab">                                            
                                                    <div ng-switch-when="matched"> <?php echo("$countss"); ?> Matches </div>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                        <ul class="people-list-big">
                                            ...
                                            <?php
                                                $sqlf = mysql_query("SELECT * FROM applicants WHERE jid='$jid' AND status=\"Shortlisted\"");
                                                while($rowf = mysql_fetch_array($sqlf))
                                                {
                                                    $uid = $rowf['uid'];
