                                ...
                                <div class="wrapper">
                                    ...
                                    <div class="content">
                                        ...
                                        <table width="100%">
                                            ...
                                            <?php
                                                $sqlm = "SELECT * FROM messages WHERE uid=$uid ORDER BY date_sent DESC;";
                                                ...
                                                <a class="btn btn-md btn-red" href="candidate-dashboard.php" ui-sref="business-jobs.live({businessId: companyId})">
