                                    ...
                                    <div class="content">                                                                
                                        ...
                                        <?php
                                            ...
                                            {                
                                                ...
                                                $res=mysql_query($sql);                                                    
                                                echo '<b>Meeting Confirmed. Message has been sent.</b><br />';                                                                                                            
                                            }
                                            ...
                                            {                
                                                ...
                                                $res=mysql_query($sql);                                                    
                                                echo '<b>Meeting Rejected. Message has been sent.</b><br />';
                                            }

                                            $sqlm = "SELECT * FROM messages WHERE id=\"$mid\";";
                                            ...
                                            {                                                                                                                                                    
                                                ...
                                                <br />
                                                <img src="profile/<?php echo $uphoto; ?>" width="100" />
                                                <br />                                                                                                                                                                

                                                <b><?php echo $fname.' '.$lname; ?></b> has been invited for the position of                                            
                                                ...
                                                <?php                                                 
                                                    ...
                                                    {
                                                    ?>
                                                    <span class="msg">The user has been invited.</span>
                                                    <a class="btn btn-md btn-green" href="company-view-messages.php?mid=<?php echo $mid; ?>&action=confirm">
                                                        <span>Accept Invite on Behalf</span>
                                                    </a>
                                                    <?php
                                                    }
                                                    if($status =='0')
                                                    {
                                                    ?>
                                                    <span class="msg">The user was rejected.</span>
                                                    <a class="btn btn-md btn-red" href="company-dashboard.php">
                                                        <span>View Jobs</span>
                                                    </a>
                                                    <?php
                                                    }
                                                    ...
                                                    {
                                                    ?>
                                                    <span class="msg">This user Accepted the Invitation</span>
                                                    <a class="btn btn-md btn-red" href="company-view-messages.php?mid=<?php echo $mid; ?>&action=delete">
