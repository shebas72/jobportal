<?php
    ...
    if(($_SESSION['email'])&&($_SESSION['password']))
    {
        ...
        $sqlck1 = "SELECT * FROM candidate WHERE email='$email' AND password='$password' AND fname='';";
        $resck1=mysql_query($sqlck1);
        $count1=mysql_num_rows($resck1);
        echo $sqlck1;
        if($count1==1)
        {
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Candidate Login | myjob.sa</title>
                                ...
                                <div class="col-xs-12 login-content">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 pull-left text-left">
                                            <a translate="" ui-sref="company-forgot" href="forgot-candidate.php">
                                                <strong>Forgot Password?</strong>
                                            </a>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 pull-right text-right">
                                            Don't have account?
                                            <a ui-sref="register({side: 'company'})" href="register-candidate.php">
