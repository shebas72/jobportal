                        ...
                        <div class="container">
                            <div class="container-sm-height">
                                <div class="row-sm-height">
                                    ...
                                    <a class="col-xs-12 col-sm-3 col-sm-height btn btn-transparent" ui-sref="business-jobs.closed" ui-sref-active="active" href="company-closedjobs.php?bid=<?php echo $bid; ?>">
                                        Closed Jobs
                                        <?php
                                    ...
                                    <a class="col-xs-12 col-sm-3 col-sm-height btn btn-transparent active" ui-sref="business-jobs.pending" ui-sref-active="active" href="company-pendingjobs.php?bid=<?php echo $bid; ?>">
                                        Pending Jobs
                                        <?php
                        ...
                        <div class="container">
                            <div ui-view="">
                                <ul class="list-style-none">
                                    ...
                                    <?php
                                        $sqljobcheck = "SELECT * FROM jobs WHERE bid=\"$bid\" AND isactive=4;";    
