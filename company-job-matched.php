                            ...
                            <div class="container">
                                <div class="container-sm-height">
                                    <div class="row-sm-height">
                                        ...
                                        <div class="col-xs-12 col-sm-height btn btn-transparent col-sm-2 active" href="company-job-matched.php?jid=<?php echo $jid; ?>" onclick="location.href='company-job-matched.php?jid=<?php echo $jid; ?>'">
                                            Matched
                                            <?php
                                ...
                                <div class="col-xs-12">
                                    <div ui-view="">
                                        <div>
                                            <div class="pull-right found-count">
                                                <div ng-switch="vj.tab">                                            
                                                    <div ng-switch-when="matched"> <?php echo("$countmm"); ?> Matches </div>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                        <ul class="people-list-big">
                                            ...
                                            <?php
                                                $sqlf = mysql_query("SELECT * FROM candidate WHERE jobrole LIKE \"%$jjrole%\"");                                                
                                                while($rowf = mysql_fetch_array($sqlf))
                                                {
                                                    $uid = $rowf['uid'];
                                                        ...
                                                        <applicant-item currenttab="tab" count="vm.countApps" application="application">
                                                            ...
                                                            <div class="col-xs-12 col-sm-8 col-lg-9 text-center-xs person-meta">
                                                                ...
                                                                <div class="candidate-actions">
                                                                    <a class="btn btn-md btn-red" href="company-viewmatched.php?uid=<?php echo $uid; ?>">
                                                                        <span>View Match</span>
                                                                    </a>
                                                                    <a class="btn btn-md btn-light-grey" href="company-job-invited.php?jid=<?php echo $jid; ?>&uid=<?php echo $uid; ?>&action=invite">
