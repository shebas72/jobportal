<?php
    ...
    if(($_SESSION['email'])&&($_SESSION['password']))
    {
        ...
        $sqlusercheck = "SELECT * FROM jobs WHERE id=\"$jid\";";    
        $resusercheck = mysql_query($sqlusercheck);                                                                
        if(mysql_num_rows($resusercheck) == 1) 
        {
            while($row = mysql_fetch_array($resusercheck)) 
...
<html class="no-js" lang="en" ng-strict-di="" ng-app="scootApp">
    <head>        
        ...
        <title page-title="">Edit Job - myjob.sa</title>
                ...
                <div class="job-edit-page user-edit-page user-register-page post-a-job">
                    <div class="page-header-title text-center">
                        <h1 class="heading" translate="">
                            <span>Edit "<?php echo $jname; ?>" job at <?php echo $bname; ?></span>
                        </h1>
                        ...
                        <?php
                            if($success==1)
                            {
                                $sql="UPDATE jobs SET
                                        ...
                                        jrole=\"$jrole\", 
                                        skillcert=\"$skillcertall\", 
                                        jlocation=\"$jlocation\", 
                                        salaryfrom=\"$salaryfrom\", 
                                        salaryto=\"$salaryto\", 
                                        salaryperiod=\"$salaryperiod\", 
                                        jobsalaryhide=\"$jobsalaryhide\", 
                                        jobeducation=\"$jobeducation\", 
                                        acceptsforeigners=\"$acceptsforeigners\", 
                                        language=\"$languageall\"
                                        WHERE id=$jjid;";
                                $res=mysql_query($sql);                                
                                echo '<META http-equiv="refresh" content="0;URL=company-previewjob.php?jid='.$jjid.'">';
                            }
                        ?>
                    ...
                    <div class="container">
                        <form class="ng-invalid ng-invalid-required ng-valid-maxlength ng-valid-pattern ng-dirty ng-valid-minlength ng-valid-parse" novalidate="" name="addJobForm" method="post">
                                ...
                                <div class="form-section">
                                    <div class="col-xs-12 col-sm-10 col-sm-push-1 col-md-8 col-md-push-2">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <input id="jobtitle" name="jobtitle" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength" type="text" ng-required="true" ng-maxlength="70" ng-minlength="3" ng-model="job.title" placeholder="Start Typing Job Title" required="required" value="<?php echo $jname; ?>">
                                                    <?php                                                                
                                                    if($errname==1)
                                                    {
                                                    ?>
                                ...
                                <div class="form-section">
                                    <div class="col-xs-12 col-sm-10 col-sm-push-1 col-md-8 col-md-push-2">
                                        <div class="form-group" ng-class="{'has-error': ((addJobForm.$submitted || addJobForm.jobTitle.$touched) && addJobForm.jobDescription.$invalid)}">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <textarea id="jobabout" name="jobabout" class="form-control" style="height: 200px;"><?php echo $jjobabout; ?></textarea>
                                    ...
                                    <div class="col-sm-6 col-xs-12 ">
                                        <div class="form-section half">
                                            <div class="form-group col-xs-12 col-md-8 col-md-push-2 text-left">
                                                ...
                                                <?php
                                                    $jbene = array_map('trim', explode(",", $jbenefits));                                                    
                                                ?>                                                                                                
                                                
                                                <label class="col-xs-12 row-2">
                                                    <input  type="checkbox" name="benefits[]" value="Company trips" <?=(in_array('Company trips', $jbene)?'checked="checked"':NULL)?> />
                                                    Company trips
                                                </label>
                                                <label class="col-xs-12 row-2">
                                                    <input  type="checkbox" name="benefits[]" value="Gym/fitness memberships" <?=(in_array('Gym/fitness memberships', $jbene)?'checked="checked"':NULL)?> />
                                                    Gym/fitness memberships
                                                </label>
                                                <label class="col-xs-12 row-2">
                                                    <input  type="checkbox" name="benefits[]" value="Medical insurance" <?=(in_array('Medical insurance', $jbene)?'checked="checked"':NULL)?> />
                                                    Medical insurance
                                                </label>
                                                <label class="col-xs-12 row-2">
                                                    <input  type="checkbox" name="benefits[]" value="Parking allowance" <?=(in_array('Parking allowance', $jbene)?'checked="checked"':NULL)?> />
                                                    Parking allowance
                                                </label>
                                                <label class="col-xs-12 row-2">
                                                    <input  type="checkbox" name="benefits[]" value="Pension scheme" <?=(in_array('Pension scheme', $jbene)?'checked="checked"':NULL)?> />
                                                    Pension scheme
                                                </label>
                                                <label class="col-xs-12 row-2">
                                                    <input  type="checkbox" name="benefits[]" value="Team building activities" <?=(in_array('Team building activities', $jbene)?'checked="checked"':NULL)?> />
                                                    Team building activities
                                                </label>
                                                <label class="col-xs-12 row-2">
                                                    <input  type="checkbox" name="benefits[]" value="Training" <?=(in_array('Training', $jbene)?'checked="checked"':NULL)?> />
                                                    Training
                                                </label>                                                                                                                                                
                                            </div>
                                            <div class="clearfix"></div>
                                    ...
                                    <div class="col-sm-6 col-xs-12 ">
                                        <div class="form-section half">
                                            <div class="form-group col-xs-12 col-md-8 col-md-push-2 text-left">
                                                ...
                                                <?php
                                                    $jetyp = array_map('trim', explode(",", $jetype));                                                    
                                                ?>
                                                ...
                                                <label id="job-type-of-employment" class="col-xs-12 row-2" >
                                                    <input  type="checkbox" name="etype[]" value="Full Time" <?=(in_array('Full Time', $jetyp)?'checked="checked"':NULL)?> />
                                                    Full Time
                                                </label>
                                                <label id="job-type-of-employment" class="col-xs-12 row-2" >
                                                    <input  type="checkbox" name="etype[]" value="Part Time" <?=(in_array('Part Time', $jetyp)?'checked="checked"':NULL)?> />
                                                    Part Time
                                                </label>
                                                <label id="job-type-of-employment" class="col-xs-12 row-2" >
                                                    <input  type="checkbox" name="etype[]" value="Internship" <?=(in_array('Internship', $jetyp)?'checked="checked"':NULL)?> />
                                                    Internship
                                                </label>
                                                <label id="job-type-of-employment" class="col-xs-12 row-2" >
                                                    <input  type="checkbox" name="etype[]" value="Volunteer" <?=(in_array('Volunteer', $jetyp)?'checked="checked"':NULL)?> />
                                                    Volunteer
                                                </label>
                                                <label id="job-type-of-employment" class="col-xs-12 row-2" >
                                                    <input  type="checkbox" name="etype[]" value="Freelance / Temporary" <?=(in_array('Freelance / Temporary', $jetyp)?'checked="checked"':NULL)?> />
                                                    Freelance / Temporary
                                                </label>
                                                <label id="job-type-of-employment" class="col-xs-12 row-2" >
                                                    <input  type="checkbox" name="etype[]" value="Fresh Graduate" <?=(in_array('Fresh Graduate', $jetyp)?'checked="checked"':NULL)?> />
                                                    Fresh Graduate
                                                </label>                                                
                                            </div>
                                            <div class="clearfix"></div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <select id="jobcategory" name="jobcategory" class="form-control custom-select ng-pristine ng-untouched ng-valid ng-not-empty">
                                                            <option value="<?php echo $jjobcategory; ?>"><?php echo $jjobcategory; ?></option>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12 force-width-100">
                                                        <input type="text" id="jrole" name="jrole" class="input-block-level form-control ng-empty ng-valid" type="text" placeholder="Enter the key role" value="<?php echo $jjrole; ?>">                                                        
                                                    </div>
                                                </div>
                                                <div class="form-group" >
                                                ...
                                                <div class="form-group" style="margin-bottom: 0;">
                                                    ...
                                                    <div class="col-xs-12">
                                                        <input id="jlocation" name="jlocation" class="input-block-level form-control ng-empty ng-valid" type="text" placeholder="Start typing your location" value="<?php echo $jjlocation; ?>">
                                                    </div>
                                                    <div class="clearfix"></div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4 col-md-4 row-2 salary-from">
                                                        <div class="col-sm-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input value="<?php echo $jsalaryfrom; ?>" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-pattern" type="text" ng-required="true" ng-pattern="/^[0-9]+$/" placeholder="From" ng-model="job.salaryFrom" name="salaryfrom" id="salaryfrom" required="required">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4 col-md-4 row-2 salary-to">
                                                        <div class="col-sm-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input value="<?php echo $jsalaryto; ?>" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-pattern" type="text" ng-required="true" ng-pattern="/^[0-9]+$/" placeholder="To" ng-model="job.salaryTo" name="salaryto" id="salaryto" required="required">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="col-sm-12">
                                                            <label>
                                                                <input class="reg-chck ng-untouched ng-valid ng-dirty ng-valid-parse ng-empty" type="checkbox" name="jobsalaryhide" id="jobsalaryhide" value="1" <?php if($jjobsalaryhide=='1'){ echo 'checked="checked"'; }?>>                                                                
                                                                Hide salary
                                                            </label>
                                                        </div>
                                                        <div class="col-xs-12"> </div>
                                                ...
                                                <div class="col-xs-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="jobeducation" name="jobeducation" class="form-control custom-select ng-touched ng-not-empty ng-dirty ng-valid-parse ng-valid ng-valid-required">
                                                            <option label="<?php echo $jjobeducation; ?>" value="<?php echo $jjobeducation; ?>"><?php echo $jjobeducation; ?></option>
                            ...
                            <input type="hidden" name="jjid" value="<?php echo $jid; ?>">
