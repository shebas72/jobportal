...
<html class="no-js" lang="en" ng-strict-di="" ng-app="scootApp">
    <head>
        ...
        <title page-title="">Edit Business - myjob.sa</title>
                            ...
                            <form class="ng-pristine ng-invalid ng-invalid-required ng-valid-pattern ng-valid-minlength ng-valid-maxlength" ng-submit="vm.create()" novalidate="" name="addBusinessForm" method="post" enctype='multipart/form-data'>
                                    ...
                                    <div class="col-xs-12 col-sm-10 col-sm-push-1 col-md-8 col-md-push-2">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <div class="user-edit-image text-center">
                                                <div class="user-edit-image business-edit-image" ng-class="{'user-image': vm.business.profileImg && vm.business.profileImg != 'profile/<?php echo $bimage; ?>'}" style="background-image: url('profile/<?php echo $bimage; ?>');" ng-if="!vm.showLoader"> </div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                                ...
                                                {                                                    
                                                    ...
                                                    if(!$_FILES['photo']['error'])
                                                    {
                                                        ...
                                                        if($valid_file)
                                                        {
                                                            ...
                                                            $sqlupdi="UPDATE business SET image = \"$new_file_name\" WHERE id=$bbid;";
                                                            $resupdi=mysql_query($sqlupdi);                                                                                                                                                                                                                                                                                                                            
                                ...
                                <div class="form-section">
                                    <div class="col-xs-12 col-sm-10 col-sm-push-1 col-md-8 col-md-push-2">
                                        <div class="form-group">
                                            ...
                                            <textarea id="businessabout" name="businessabout" class="form-control" style="height: 200px;"><?php echo $bdescription; ?></textarea>                                                
                                ...
                                <div class="form-section">
                                    <div class="col-xs-12 col-sm-10 col-sm-push-1 col-md-8 col-md-push-2">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <select id="jobcategory" name="jobcategory" class="chosen-select ng-untouched localytics-chosen ng-not-empty ng-dirty ng-valid-parse ng-valid ng-valid-required" data-placeholder="Select an option" ng-required="true" tabindex="-1" style="width: 100%;" ng-options="c.id as c.name for c in categories | orderBy: 'name'" ng-model="company.businesses[0].categoryId" chosen="" required="required">
                                                        <option label="<?php echo $bindustry; ?>" value="<?php echo $bindustry; ?>"><?php echo $bindustry; ?></option>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <input id="location" name="location" class="form-control input-block-level form-control ng-dirty ng-valid-parse ng-empty ng-invalid ng-invalid-required ng-touched" type="text" placeholder="Enter your location"  required="required" value="<?php echo $blocation; ?>">
                                ...
                                <div class="job-edit-cta">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-4 pull-left">
                                            <button class="btn-step btn pull-left" translate="" onclick="window.location.href = 'company-dashboard.php?deletebid=<?php echo $bid ?>'" confirm="are you sure you want to delete this business?" type="button" ng-click="vm.delete()">
                                                <span>DELETE</span>
                                            </button>
                                        </div>
                                        <div class="clearfix"></div>
