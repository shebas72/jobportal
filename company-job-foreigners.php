                            ...
                            <div class="container">
                                <div class="container-sm-height">
                                    <div class="row-sm-height">
                                        ...
                                        <div class="col-xs-12 col-sm-2 col-sm-height btn btn-transparent active" href="company-job-foreigners.php?jid=<?php echo $jid; ?>" onclick="location.href='company-job-foreigners.php?jid=<?php echo $jid; ?>'">
                                            Foreigners
                                            <?php
                                                $ff=0;
                                        ...
                                        <div>
                                            <div class="pull-right found-count">
                                                <div ng-switch="vj.tab">                                            
                                                    <div ng-switch-when="matched"> <?php echo("$ff"); ?> Matches </div>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
